...
"""New: exports to excel instead of separte text files"""
...
def outputTable(a_book, a_table, sheet_num, output_file_name):
	import xlwt
	book = a_book
	try:
		cols = len(a_table[0])
	...
	for x in range(0, rows):
		for y in range(0, cols):
			sheet_num.write(x, y, a_table[x][y])
...
#modify with 'sheet' in each without numbering, but returning the sheet as sheet1, sheet2, etc...
