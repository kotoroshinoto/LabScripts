...
SJM_JOB_AFTER "$GROUPLBL"_VARSCAN_NC_TC_somatic "$GROUPLBL"_MPILEUP_PAIR_NC_TC_pileup
SJM_JOB_AFTER "$GROUPLBL"_VARSCAN_NC_TF_somatic "$GROUPLBL"_MPILEUP_PAIR_NC_TF_pileup
SJM_JOB_AFTER "$GROUPLBL"_VARSCAN_NF_TF_somatic "$GROUPLBL"_MPILEUP_PAIR_NF_TF_pileup
SJM_JOB_AFTER "$GROUPLBL"_VARSCAN_NC_NF_somatic "$GROUPLBL"_MPILEUP_PAIR_NC_NF_pileup
SJM_JOB_AFTER "$GROUPLBL"_VARSCAN_TC_TF_somatic "$GROUPLBL"_MPILEUP_PAIR_TC_TF_pileup
